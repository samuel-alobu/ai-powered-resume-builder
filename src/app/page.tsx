    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-gray-100 px-5 py-12 text-center text-gray-900 md:flex-row md:text-start lg:gap-12">
      <div className="max-w-prose space-y-3">
        ...
        <p className="text-lg text-gray-500">
          ...
          craft a standout resume that highlights your skills and experience,
        ...
        <Button
          ...
          size="lg"
          variant="premium"
          className="bg-gradient-to-r from-green-600 to-green-400 text-white shadow hover:from-green-600/90 hover:to-green-400/90"
        >
